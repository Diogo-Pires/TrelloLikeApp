...
internal class EmailService(IOptions<SmtpSettings> smtpSettings,
                            GlobalExceptionHandler exceptionHandler) : IEmailService
{
    ...
    {            
        ...
        try
        {
            ...
            await smtpClient.AuthenticateAsync(_smtpSettings.Email, _smtpSettings.Password, cancellationToken);
